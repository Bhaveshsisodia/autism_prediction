from Autism.entity.config_entity import TrainingPipelineConfig, DataIngestionConfig,\
 DataValidationConfig , DataTransformationConfig , ModelEvaluationConfig , ModelPusherConfig,\
ModelTrainerConfig
from Autism.logger import logging
from Autism.entity.artifact_entity import DataIngestionArtifact, DataValidationArtifact , DataTransformationArtifact,\
...
class TrainPipeline:
    ...
    def start_data_ingestion(self):
        try:
            ...
            logging.info(f"Data Ingestion Compeleted and artifact : {data_ingestion_artifact}")
    ...
    def run_pipeline(self):
        try:
            ...
            if not model_eval_artifact.is_model_accepted:
                raise Exception("Trainer model is not better than the best model")
