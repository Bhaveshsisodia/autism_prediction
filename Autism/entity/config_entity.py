from Autism.constant import training_pipeline
import os
...
class ModelTrainerConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        self.model_config_file_path: str = training_pipeline.MODEL_CONFIG_FILE_PATH
...
class ModelEvaluationConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.model_evaluation_dir: str = os.path.join(
            training_pipeline_config.artifact_dir, training_pipeline.MODEL_EVALUATION_ARTIFACT_DIR
        )
        self.model_evaluation_file_path = os.path.join(self.model_evaluation_dir,training_pipeline.MODEL_EVALUATION_FILE_NAME)
