...
from Autism.entity.artifact_entity import DataIngestionArtifact
...
class DataIngestion:
    ...
    def __init__(self, data_ingestion_config:DataIngestionConfig):
        try:
            ...
            print(SCHEMA_FILE_PATH,os.getcwd())
    ...
    def split_data_as_train_test(self, dataframe:DataFrame)-> None:
        # sourcery skip: raise-from-previous-error, remove-redundant-fstring
        """
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        ...
        try:
            ...
            logging.info("******************************** Data Ingestion Done Successefully**********************************************\n")
